...
def draw_navigation(screen, font, tabs, active_tab):
    ...
    for i, tab in enumerate(tabs):
        ...
        text_surface = font.render(tab, True, GREEN)
    ...
    if b_left > 10:
        pygame.draw.line(screen, GREEN, (10, line_y), (b_left, line_y), 2)
        
    pygame.draw.lines(screen, GREEN, False, [(b_left, line_y), (b_left, b_top), (b_left + tick_width, b_top)], 2)
    pygame.draw.lines(screen, GREEN, False, [(b_right - tick_width, b_top), (b_right, b_top), (b_right, line_y)], 2)

    if b_right < WIDTH - 10:
        pygame.draw.line(screen, GREEN, (b_right, line_y), (WIDTH - 10, line_y), 2)

    pygame.draw.line(screen, GREEN, (10, HEIGHT - 35), (WIDTH - 10, HEIGHT - 35), 2) 
    
    if active_tab not in [3, 4]:
        # --- FOOTER STATS ---
        hp_text = font.render("HP 100/100", True, GREEN)
        screen.blit(hp_text, (20, HEIGHT - 28))
    
        ap_text = font.render("AP 50/50", True, GREEN)
        ...
        # Draw Level Text
        level_text = font.render(f"LEVEL {age}", True, GREEN)
        ...
        bar_width = 80
        bar_height = 8
        pygame.draw.rect(screen, GREEN, (bar_x, bar_y, bar_width, bar_height), 1)
